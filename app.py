...
# ── Comparison page callable (title shown in Streamlit navigation) ────────────
...
# ── Navigation ────────────────────────────────────────────────────────────────
# Explicit st.navigation() so the main page shows a proper title
# instead of 'app' derived from the filename.
_pg = st.navigation([
    st.Page(_comparison_page, title="RAG vs Agentic", icon="🤖", default=True),
    st.Page("pages/📊_Eval_Dashboard.py", title="Eval Dashboard", icon="📊"),
    st.Page("pages/🧪_Model_Comparison.py", title="Model Comparison", icon="🧪"),
    st.Page("pages/🕸️_Knowledge_Graph.py", title="Knowledge Graph", icon="🕸️"),
])
_pg.run()
